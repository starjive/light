...
/*-----------------------------------------------------------------------------------*/
/* Remove metaboxes from specific custom post types
/*-----------------------------------------------------------------------------------*/
...
if ( ! function_exists( 'sf_load_woocommerce_css' ) ) {
	/**
	 * WooCommerce Styles
	 * Enqueue WooCommerce styles
	 */
	function sf_load_woocommerce_css () {
		wp_register_style( 'woocommerce', get_template_directory_uri() . '/app/frontend/integrations/woocommerce/css/woocommerce.css' );
		wp_enqueue_style( 'woocommerce' );
	} // End sf_load_woocommerce_css()
}

if ( ! function_exists( 'sf_wc_disable_css' ) ) {
	function sf_wc_disable_css() {
		/**
...
/* Install
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'sf_install_theme' ) ) {
	function sf_install_theme() {
