(function($) {
	$(document).ready(function() {
		...
		$( '.upload-field .input-upload' ).on( 'blur', function ( e ) {
			...
			image_preview = $el.parents( '.sf-field-upload' ).find( '.image-preview' );
		...
		$( '.sf-field-upload .remove, .sf-field-upload-min .remove' ).on( 'click', function ( e ) {
			var $el = $( this );

			container = $el.parents( 'td' ).find( '.upload-field' ); // We use td instead of a CSS class to cater for both sf-field-upload and sf-field-upload-min.
		...
		$( '.upload-field a.button' ).on( 'click', function( e ) {
				...
				frame.on( 'select', function() {
					...
					image_preview =  container.parent( '.sf-field' ).find( '.image-preview' );
