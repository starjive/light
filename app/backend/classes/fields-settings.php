...
class SF_Fields_Settings extends SF_Fields {
	protected $_has_tabs;
	...
	public function get_script_supported_fields () {
		return (array)apply_filters( 'sf_get_script_supported_fields', array( 'sf_ad_top_adsense', 'sf_ad_content_adsense', 'sf_google_analytics' ) );
